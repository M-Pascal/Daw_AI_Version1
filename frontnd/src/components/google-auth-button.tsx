...
export function GoogleAuthButton() {
  return (
    <Link href="/api/auth/google" className={buttonVariants({ variant: "outline", className: "w-full" })}>
      <svg viewBox="0 0 24 24" className="h-4 w-4" aria-hidden="true">
        ...
        <path
          fill="#FBBC05"
          d="M5.27 14.28A7.14 7.14 0 0 1 4.9 12c0-.79.14-1.56.37-2.28V6.63H1.29A11.98 11.98 0 0 0 0 12c0 1.94.46 3.77 1.29 5.37l3.98-3.09z"
        />
        <path
          fill="#EA4335"
